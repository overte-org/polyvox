...
int main(int argc, char* argv[]) {
    ...
    VolumeResampler<SimpleVolume<uint8_t>, RawVolume<uint8_t>> volumeResampler(&volData,
                                                                               PolyVox::Region(Vector3DInt32(0, 0, 0),
                                                                                               Vector3DInt32(31, 63, 63)),
                                                                               &volDataLowLOD,
                                                                               volDataLowLOD.getEnclosingRegion());
    volumeResampler.execute();

    // Extract the surface
    SurfaceMesh<PositionMaterialNormal> meshLowLOD;
    MarchingCubesSurfaceExtractor<RawVolume<uint8_t>> surfaceExtractor(&volDataLowLOD, volDataLowLOD.getEnclosingRegion(),
                                                                       &meshLowLOD);
    ...
    MarchingCubesSurfaceExtractor<SimpleVolume<uint8_t>> surfaceExtractorHigh(&volData,
                                                                              PolyVox::Region(Vector3DInt32(30, 0, 0),
