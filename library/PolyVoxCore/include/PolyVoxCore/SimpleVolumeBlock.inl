...
template <typename VoxelType> SimpleVolume<VoxelType>::Block::~Block() {
...
template <typename VoxelType>
VoxelType SimpleVolume<VoxelType>::Block::getVoxelAt(uint16_t uXPos,
                                                     uint16_t uYPos,
...
template <typename VoxelType>
VoxelType
SimpleVolume<VoxelType>::Block::getVoxelAt(const Vector3DUint16 &v3dPos) const {
  return getVoxelAt(v3dPos.getX(), v3dPos.getY(), v3dPos.getZ());
}

template <typename VoxelType>
void SimpleVolume<VoxelType>::Block::setVoxelAt(uint16_t uXPos, uint16_t uYPos,
                                                uint16_t uZPos,
                                                VoxelType tValue) {
  assert(uXPos < m_uSideLength);
  assert(uYPos < m_uSideLength);
...
template <typename VoxelType>
void SimpleVolume<VoxelType>::Block::setVoxelAt(const Vector3DUint16 &v3dPos,
                                                VoxelType tValue) {
...
uint32_t SimpleVolume<VoxelType>::Block::calculateSizeInBytes(void) {
  ...
  uSizeInBytes +=
      sizeof(VoxelType) * m_uSideLength * m_uSideLength * m_uSideLength;
  return uSizeInBytes;
}
} // namespace PolyVox
