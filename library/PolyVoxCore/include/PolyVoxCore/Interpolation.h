...
template <typename Type>
Type bilerp(const Type &v00, const Type &v10, const Type &v01, const Type &v11,
...
template <typename Type>
Type trilerp(const Type &v000, const Type &v100, const Type &v010,
             const Type &v110, const Type &v001, const Type &v101,
             const Type &v011, const Type &v111, const float x, const float y,
             const float z) {
  assert((x >= 0.0f) && (y >= 0.0f) && (z >= 0.0f) && (x <= 1.0f) &&
         (y <= 1.0f) && (z <= 1.0f));
  ...
  Type v000_v100__v010_v110____v001_v101__v011_v111 =
