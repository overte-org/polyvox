...
/// this is simpler than providing a large number of get/set properties within
/// the AStarPathfinder itself. In order to create an instance of this structure
/// you must provide at least a volume, a start and end point, and a list to
/// store the result. All the other option have sensible default values which
/// can optionally be changed for more precise control over the pathfinder's
/// behaviour.
///
/// \sa AStarPathfinder
////////////////////////////////////////////////////////////////////////////////
...
/// constructor. The details of the AStarPathfinderParams and the options it
/// provides are described in the documentation for that class.
///
