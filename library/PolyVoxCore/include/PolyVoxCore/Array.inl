...
namespace PolyVox {
////////////////////////////////////////////////////////////////////////////////
/// Creates an empty array with no elements. You will have to call resize() on
...
/// \param pDimensions The dimensions of the array. You can also use the
/// ArraySizes class to construct this more easily.
/// \sa ArraySizes
////////////////////////////////////////////////////////////////////////////////
template <uint32_t noOfDims, typename ElementType>
...
////////////////////////////////////////////////////////////////////////////////
/// An N-dimensional array can be conceptually consists of N subarrays each of
/// which has N-1 dimensions. For example, a 3D array conceptually consists of
/// three 2D arrays. This operator is used to access the subarray at the
/// specified index. Crucially, the subarray defines a similar operator allowing
/// them to be chained together to convieniently access a particular element.
...
/// going through this classes interface. Although this does not honour the
/// principle of encapsulation it can be done safely if you are careful and can
/// sometimes be useful. Use getNoOfElements() to determine how far you can
/// safely write.
...
////////////////////////////////////////////////////////////////////////////////
/// Because this class does not have a public assignment operator or copy
/// constructor it cannot be used with the STL swap() function. This function
/// provides an efficient implementation of that feature.
