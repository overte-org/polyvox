...
Block<VoxelType>::Block(uint16_t uSideLength) :
    m_tUncompressedData(0), m_uSideLength(0), m_uSideLengthPower(0), m_bIsCompressed(true),
...
VoxelType Block<VoxelType>::getVoxelAt(uint16_t uXPos, uint16_t uYPos, uint16_t uZPos) const {
    ...
    return m_tUncompressedData[uXPos + uYPos * m_uSideLength + uZPos * m_uSideLength * m_uSideLength];
}
...
void Block<VoxelType>::setVoxelAt(uint16_t uXPos, uint16_t uYPos, uint16_t uZPos, VoxelType tValue) {
    ...
    m_tUncompressedData[uXPos + uYPos * m_uSideLength + uZPos * m_uSideLength * m_uSideLength] = tValue;
