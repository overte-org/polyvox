...
////////////////////////////////////////////////////////////////////////////////
///  While C++ provides one-dimensional arrays as a language feature, it does
///  not provide a simple and intuitive way of working with multidimensional
///  arrays whose sizes are specified at runtime. Such a construct is very
///  useful within the context of PolyVox, and this Array class provides such
///  functionality implemented via templates and partial specialisation.
///
///  The following code snippet illustrates the basic usage of the class by
///  writing a different value into each element:
///
///  \code
///  int width = 5;
///  int height = 10;
...
///  \endcode
///
///  Although the constructor and resize() functions both take the required
///  dimensions as an array of ints, note that the ArraySizes class can be used
///  to build this inline. This is a more convienient way of specifying these
///  dimensions.
///
///  Note also that this class has a private assignment operator and copy
///  constructor in order to prevent copying. This is because a deep copy is a
///  potentially slow operation and can often be performed inadvertently by
