...
void testForType(SurfaceMesh<PositionMaterialNormal>& result) {
    ...
    MarchingCubesSurfaceExtractor<SimpleVolume<VoxelType>> extractor(&volData, volData.getEnclosingRegion(), &result,
                                                                     controller);
    extractor.execute();
}
...
void testCustomController(SurfaceMesh<PositionMaterialNormal>& result) {
    ...
    MarchingCubesSurfaceExtractor<SimpleVolume<float>, CustomMarchingCubesController> extractor(&volData,
