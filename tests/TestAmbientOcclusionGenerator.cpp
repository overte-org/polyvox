...
bool isVoxelTransparentFunction(uint8_t voxel) { return voxel == 0; }
...
void TestAmbientOcclusionGenerator::testExecute() {
  ...
  Array<3, uint8_t> ambientOcclusionResult(
      ArraySizes(g_uArraySideLength)(g_uArraySideLength)(g_uArraySideLength));
  ...
  QBENCHMARK {
    calculateAmbientOcclusion(&volData, &ambientOcclusionResult,
                              volData.getEnclosingRegion(), 32.0f, 255,
                              isVoxelTransparent);
  }
  ...
  // pointer
  calculateAmbientOcclusion(&volData, &ambientOcclusionResult,
                            volData.getEnclosingRegion(), 32.0f, 8,
